...
構想から1年半を経て，書籍になりました。[ラムダノート](https://www.lambdanote.com/)さんから発刊です。
...
情報検索の歴史を紐解くところから始まり，検索エンジン，ユーザーインターフェース，性能評価，Query Understanding，ランキング学習，と幅広くカバーした内容になっており，「実務家のための教科書」を目指して著者一同頑張って執筆しました。
